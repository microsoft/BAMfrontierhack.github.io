...
> **Reminder:** Balance your own reflection with Copilot insights—neither replaces the other.  Use Copilot to surface ideas, then reflect to decide what resonates most.

### Task 1: Explore Challenges or Opportunities

Use **Copilot Chat** to identify common challenges in your day‑to‑day work.

**Steps**

- Open a new browser tab and navigate to `m365.cloud.microsoft/chat`.  
...
> Replace the text within brackets with your specific role focus (e.g., program management).  
> **Tip:** You can ask Copilot to output the full table directly into a Word document for easier sharing. For extra help writing or refining prompts, try Prompt Coach.
...
> Use the `/` reference feature in Copilot Chat to tag the leader or manager by name.

### Task 3: Select Your Problem Statement

Choose one challenge or opportunity to carry forward.  Capture it clearly and simply—this will be your problem statement for the rest of the lab.
